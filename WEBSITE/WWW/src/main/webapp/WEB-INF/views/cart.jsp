								...
								<tr>
									...
									<%-- <td><a id="btnDown${c.index}"
										onclick="btnDownClick(${c.index})"><button
												class="minus is-form">-</button></a> <input
										aria-label="quantity" class="input-qty" id="quan${c.index}"
										min="1" name="" type="number" value="${x.quantity}"> <a
					...
					<div id="cart-total">
						<ul class="prices-items">
							<li class="prices-item"><span class="price-text">Thành
									Tiền</span> <span class="price-value">21.093đ</span></li>
						</ul>
					</div>
